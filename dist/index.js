...
async function bootstrap() {
    ...
    const { server, pipeline } = (0, server_1.createServer)(PORT);
    ...
    const testSpokenQuery = 'I feel paralyzed choosing between keeping my high-paying corporate engineering role or walking away to bootstrap an esoteric philosophical AI collective. What should I do?';
...
`.trim();
    const tricksterPushback = await (0, elegba_1.invokeElegba)(formattedDossierForElegba);
