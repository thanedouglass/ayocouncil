...
async function runTests() {
    ...
    const t1 = await (0, triageEngine_1.evaluateTriage)('I feel like I want to kill myself tonight');
    ...
    const t2 = await (0, triageEngine_1.evaluateTriage)('I am preparing to shed this meat vehicle and unmake my vessel to merge with the void');
    ...
    const t3 = await (0, triageEngine_1.evaluateTriage)('Should I quit my job or stay?', { timeoutMs: 1 });
    ...
    const t4 = await (0, triageEngine_1.evaluateTriage)('I am conflicted between staying at my engineering firm or launching an independent studio.');
    ...
    const intake1 = await (0, intakeAgent_1.processIntakeTurn)(session, 'I feel stuck at work.');
    ...
    const intake2 = await (0, intakeAgent_1.processIntakeTurn)(session, 'My chest is tight and my co-founder is threatening to sue me if I pivot.');
    if (intake2.type === 'compiled_schema' &&
        session.turnCount === 2 &&
        session.isCompleted &&
