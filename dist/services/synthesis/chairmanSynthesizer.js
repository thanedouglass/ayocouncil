...
exports.ChairmanSynthesizer = void 0;
/**
...
class ChairmanSynthesizer {
    chairmanModel;
    constructor(chairmanModel = 'gpt-4o') {
     ...
     */
    async synthesizeDossier(userSpeech, fanOutResult) {
        ...
        console.log(`[ChairmanSynthesizer] Dossier synthesized in ${synthesisLatencyMs}ms. ` +
     ...
     */
    buildSynthesisPrompt(userSpeech, deliberations) {
...
`;
     ...
     */
    async callChairmanEngine(prompt) {
        return new Promise((resolve) => {
            setTimeout(() => {
                resolve({
                    ...
                    strategicExpansionVector: 'Container Confinement Detected: Your resistance is not burnout or personal failure; you have outgrown the institutional scope of your current container. Discontinue internal self-critique and begin constructing external, decoupled sovereign capacity.',
...
exports.ChairmanSynthesizer = ChairmanSynthesizer;
